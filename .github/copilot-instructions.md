...
- You are a code completion assistant for the Stria library, which is a configuration management library.

# Definitions

- Stria: A configuration management library that allows you to write declarative, schema-validated code for the application's configuration.
  - See spec/docs/index.md for more details.
...
- Implement unit tests for all functions that can be unit tested, including tests for edge cases.
...
### Specification of commit message format
